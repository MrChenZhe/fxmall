    ...
    <div id="banner" class="index-banner show2">
        <div class="container">
            <div class="login-wrap">
                <form id="form" method="post" action="http://localhost:8080/WxbMemeber.do?m=login">
                    ...
                    <div id="captcha" class="form-group captcha-warpper" style="margin-bottom: 5px;display: none;">
                        <input class="form-control captcha" id="captcha1" type="text" name="captcha" placeholder="验证码">
                    ...
                    <div class="form-group">
                        ...
                        <a href="http://localhost:8080/WxbMemeber.do?m=login" class="btn btn-yellow register-btn"> 注&nbsp;&nbsp;册 </a>
                    </div>            </form>
            </div>
